...
impl App {
    ...
    pub fn view(&self) -> Element<'_, Message> {
        ...
        let runner1 = widget::column![widget::text("echo one message"), runner1].spacing(10);
        let runner1 = widget::container(runner1).padding(5.0).align_x(Horizontal::Center);
